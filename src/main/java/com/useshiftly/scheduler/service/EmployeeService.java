...
import com.useshiftly.scheduler.dto.shift.ShiftTradeResponse;
...
public class EmployeeService implements UserDetailsService {
    ...
    public void sendStripeInvoice(Employee admin) {
        ...
        String subject = "Your UseShiftly Invoice";
     ...
     */
    public Optional<com.useshiftly.scheduler.model.Building> getBuildingForManager(Long managerId) {
        List<com.useshiftly.scheduler.model.Building> buildings = buildingRepository.findByManagers_Id(managerId);
    ...
    public Optional<com.useshiftly.scheduler.model.Building> getBuildingById(Long buildingId) {
        return buildingRepository.findById(buildingId);
    }

    public Optional<com.useshiftly.scheduler.model.Department> getDepartmentById(Long departmentId) {
        return departmentRepository.findById(departmentId);
    }

    
    private final com.useshiftly.scheduler.repository.BuildingRepository buildingRepository;
     ...
     */
    private final com.useshiftly.scheduler.repository.DepartmentRepository departmentRepository;
