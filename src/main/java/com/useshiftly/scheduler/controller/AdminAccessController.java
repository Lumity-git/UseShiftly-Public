...
import com.useshiftly.scheduler.dto.AdminAccessRequest;
import com.useshiftly.scheduler.service.AdminAccessService;

@RestController
@RequestMapping("/api/auth")
public class AdminAccessController {
    @Autowired
    private com.useshiftly.scheduler.service.EmployeeService employeeService;
    ...
    public ResponseEntity<?> verifyAdminCode(@RequestBody com.useshiftly.scheduler.dto.AdminCodeVerificationRequest req) {
        String ip = getClientIp();
        if (isRateLimited(ip)) {
